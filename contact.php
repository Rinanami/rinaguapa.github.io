                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        <div class="text-center mb-5">
                            ...
                            <h1 class="fw-bolder">Jarri harremanetan!</h1>
                            ...
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form id="contactForm" action="process_contact.php" method="POST">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="phone">Telefono zenbakia</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="d-grid">
                                        <button class="btn btn-primary btn-lg" id="submitButton" type="submit">Bidali</button>
                                    </div>

                                    <!-- Botón para ver los datos de la tabla -->
                                    <div class="d-grid mt-3">
                                        <a href="view_messages.php" class="btn btn-secondary btn-lg">Ver mensajes</a>
                                    </div>
                                </form>
