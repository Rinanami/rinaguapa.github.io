    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $row['password'])) {
                $_SESSION['user'] = $row['username']; // Guarda el nombre de usuario en la sesión
...
<head>
    ...
    <title>Iniciar Sesión - Rina</title>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        <div class="text-center text-xxl-start">
                            <h1 class="display-4 fw-bolder text-primary">Iniciar Sesión</h1>
                            <p class="lead fw-normal text-muted mb-4">Accede a tu cuenta para continuar.</p>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                        <form method="POST" action="" class="form-control p-4 shadow-lg rounded">
                            ...
                            <div class="mt-3">
                                <p class="small">¿No tienes una cuenta? <a href="registro.php">Regístrate aquí</a>.</p>
                            </div>
                        </form>
                    </div>
                </div>
